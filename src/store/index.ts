...
export const ExperienceInformation: ExperienceInfo[] = [
    {
        ...
        contributions: ['Engaged in research within the field of cybersecurity with a specific focus on security protocols and IoT.',
    ...
    },
    {
        ...
        contributions: ['Implemented zero-knowledge (ZK) verification functions to bolster the security and privacy of the blockchain.',
...
export const SkillsInformation: SkillsInfo[] = [
    ...
    },
    {
        ...
        skills: ['Application Security', 'Reverse Engineering (IDA, Ghydra)', 'Incident Response', 'Security Audits & Risk Analysis', 'Malware Analysis (Static and Dynamic)', 'Penetration Testing (kali, burp suite, nmap, john, nessus, metasploit)', 'Applied Cryptography', 'Security Protocols (SSL/TLS)', 'Forensics (wiresharks, autopsy, volatility)']
    },
    {
        skillsGroup: 'Systems & Network Administration',
        skills: ['Active Directory', 'Operating Systems Administration (Unix & Windows)', 'Cloud Architecture', 'Network Security (VPNs, IDS/IPS)']
    },
]
...
export const ProjectsInformation: ProjectsInfo[] = [
    {
        ...
        hasLink: false,
        date: '2024',
        description: ['Linux System Admin / OpenStack',
...
export const VolunteeringInformation: VolunteeringInfo[] = [
    {
        ...
        description: 'Helped students to get hands on experience in cybersecurity for their future career, Teaching'
    },
    {
        position: 'Software Engineering Mentor',
        organization: 'VK Education Program',
        dates: '09/2020 - 08/2021',
        description: 'Helped 20+ students to start their career in C++., Performing code-review, Teaching'
    }
]
