...
export const useTypedQualification = (
  ...
  useEffect(() => {
    switch (phase) {
      case TypePhase.Typing: {
        const nextTypedQualification = qualifications[selectedIndex].slice(
          0,
          typedQualification.length + 1
        )
      ...
      case TypePhase.Deleting: {
        ...
        const nextRemaining = qualifications[selectedIndex].slice(
          0,
          typedQualification.length - 1
        )
  ...
  return {
    ...
    phase,
    resume,
    selectedQualification: qualifications[selectedIndex],
  }
}
